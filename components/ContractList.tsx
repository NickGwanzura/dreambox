...
import { contracts as initialContracts, clients, billboards, getContracts, updateContract, subscribe } from '../services/mockData';
import { generateContractPDF } from '../services/pdfGenerator';
import { Contract, VAT_RATE } from '../types';
import { FileText, Calendar, Download, X, Eye, Clock, Plus as PlusIcon, Edit, CheckCircle } from 'lucide-react';
...
export const ContractList: React.FC = () => {
  ...
  const handleEditSave = async () => {
      ...
      try {
          ...
          const subtotal = (editContract.monthlyRate * 12) + editContract.installationCost + editContract.printingCost;
          const vat = editContract.hasVat ? subtotal * VAT_RATE : 0;
