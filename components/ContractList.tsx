...
export const ContractList: React.FC = () => {
  ...
  const handleEditSave = async () => {
      ...
      try {
          ...
          const subtotal = (editContract.monthlyRate * months) + editContract.installationCost + editContract.printingCost;
  ...
  const handleRenew = async () => {
      ...
      try {
          ...
          const months = 12;
          const subtotal = (renewContract.monthlyRate * months) + renewContract.installationCost + renewContract.printingCost;
          const vat = renewContract.hasVat ? subtotal * VAT_RATE : 0;
