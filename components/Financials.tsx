  ...
  const handleCreate = async (e: React.FormEvent) => {
      ...
      if (editingInvoice) {
          ...
          const newDoc: Invoice = {
            ...
            type: activeTab === 'Invoices' ? 'Invoice' : (activeTab as string) === 'Quotations' ? 'Quotation' : (activeTab as string) === 'Proformas' ? 'Proforma' : 'Receipt',
            contractId: formData.contractId,
