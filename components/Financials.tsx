...
export const Financials: React.FC<FinancialsProps> = ({ initialTab = 'Invoices' }) => {
  const [activeTab, setActiveTab] = useState<'Invoices' | 'Quotations' | 'Proformas' | 'Receipts' | 'Statements'>(initialTab);
  ...
  const filteredDocs = invoices.filter(i => {
      ...
      if (activeTab === 'Invoices') matchesType = iType === 'invoice'; else if (activeTab === 'Quotations') matchesType = iType === 'quotation'; else if (activeTab === 'Proformas') matchesType = iType === 'proforma'; else if (activeTab === 'Receipts') matchesType = iType === 'receipt';
