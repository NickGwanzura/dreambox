        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-slate-50">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-sm font-bold text-slate-900 uppercase tracking-wider animate-pulse">Loading Portal...</p>
                </div>
            </div>
        );
    }
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-slate-900 font-medium mt-0.5">Welcome, {client.companyName}</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3">
                        <div className="hidden sm:block text-right">
                            <p className="text-[10px] uppercase font-bold text-slate-900 tracking-wider">Account Status</p>
                        ...
                        <div className="w-8 h-8 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center text-slate-900 font-bold text-sm">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-lg transition-all duration-300 group">
                        ...
                        <p className="text-xs font-bold uppercase tracking-wider text-slate-900 mb-1">Active Assets</p>
                    ...
                    <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-lg transition-all duration-300 group">
                        ...
                        <p className="text-xs font-bold uppercase tracking-wider text-slate-900 mb-1">Outstanding Balance</p>
                        <h3 className={`text-3xl font-black tracking-tight ${totalDue > 0 ? 'text-red-600' : 'text-slate-900'}`}>${totalDue.toLocaleString()}</h3>
                    </div>
                    <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-lg transition-all duration-300 group">
                        <div className="flex items-center justify-between mb-4">
                            <div className="p-3 bg-slate-50 text-slate-900 rounded-2xl group-hover:scale-110 transition-transform"><TrendingUp size={24}/></div>
                ...
                <div>
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <span className="text-sm font-medium text-slate-900">{activeContracts.length} Locations deployed</span>
                    </div>
                                    ...
                                    <div className="p-6 flex-1 flex flex-col">
                                        ...
                                        <div className="grid grid-cols-2 gap-3 mb-6">
                                            <div className="bg-slate-50 p-3 rounded-2xl border border-slate-100">
                                                <p className="text-[10px] uppercase font-bold text-slate-900 mb-1">Dimensions</p>
                                                <p className="text-sm font-bold text-slate-700">{billboard.width}m x {billboard.height}m</p>
                                            </div>
                                            <div className="bg-slate-50 p-3 rounded-2xl border border-slate-100">
                                                <p className="text-[10px] uppercase font-bold text-slate-900 mb-1">Booking</p>
                                        ...
                                        <div className="mt-auto pt-6 border-t border-slate-100 space-y-4">
                                            <div className="flex items-center justify-between">
                                                <div>
                                                    <p className="text-[10px] uppercase font-bold text-slate-900 mb-1">Contract Duration</p>
                                            ...
                                            <div className="flex justify-between items-end">
                                                ...
                                                <div className="text-right">
                                                     <p className="text-[10px] uppercase font-bold text-slate-900 mb-0.5">Rate / Month</p>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left text-sm text-slate-900">
                                <thead className="bg-slate-50 border-b border-slate-100">
                                    <tr>
                                        <th className="px-8 py-5 font-bold text-xs uppercase text-slate-900 tracking-wider">Date</th>
                                        <th className="px-8 py-5 font-bold text-xs uppercase text-slate-900 tracking-wider">Reference</th>
                                        <th className="px-8 py-5 font-bold text-xs uppercase text-slate-900 tracking-wider">Type</th>
                                        <th className="px-8 py-5 font-bold text-xs uppercase text-slate-900 tracking-wider text-right">Amount</th>
                                        <th className="px-8 py-5 font-bold text-xs uppercase text-slate-900 tracking-wider text-center">Status</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-slate-100">
                                    ...
                                    {invoices.length === 0 && (
                                        <tr><td colSpan={5} className="px-8 py-8 text-center text-slate-900 italic">No financial history available.</td></tr>
                                    )}
                                </tbody>
                            </table>
                        </div>
                ...
                <div className="text-center text-slate-900 text-xs py-8">
